...
import { FieldValidationMarkComponent } from '../../../components/form/field-validation-mark/field-validation-mark.component';
import { FieldValidationMessageComponent } from '../../../components/form/field-validation-message/field-validation-message.component';
...
export class EditProductComponent implements OnInit{
  ...
  private loadProductToEdit(documentId: string): Observable<void> {
  ...
  public update(): void {
    ...
    this.productService.update(
      objectHelper.mapMatchingProperties(new editProductRequest(), this.mainForm.value), 
